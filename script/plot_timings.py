...
m = 5
group_colors = ['#d53e4f','#fc8d59','#fee08b','#e6f598','#99d594','#3288bd'] #['#9e0142','#d53e4f','#f46d43','#fdae61','#fee08b','#e6f598','#abdda4','#66c2a5','#3288bd','#5e4fa2'] #['#d53e4f','#fc8d59','#fee08b','#e6f598','#99d594','#3288bd'] #['#ccece6','#99d8c9','#66c2a4','#2ca25f','#006d2c'] #['#bae4bc','#7bccc4','#43a2ca','#0868ac']
single_colors = ['#9e0142','#d53e4f','#f46d43','#fdae61','#fee08b','#e6f598','#abdda4','#66c2a5','#3288bd','#5e4fa2']
gray = '#696969'
...
for i in range(0, len(y)):
    lines.append(ax.plot(x, y[types[i]], zorder = 1, color = single_colors[i], alpha = 1, linewidth = 1.5, marker = markers[i], markersize = m))
